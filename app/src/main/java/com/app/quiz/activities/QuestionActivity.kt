...
import com.app.quiz.adapters.OptionAdapter
...
//        firestore.collection("quiz").whereEqualTo("title", "10-12-2022")
        var date: String? = this.intent.getStringExtra("DATE")
...
//                        Toast.makeText(this, "$date", Toast.LENGTH_SHORT).show()
                        ...
                        Toast.makeText(this, "Sorry, This quiz has yet to come out", Toast.LENGTH_SHORT).show()
